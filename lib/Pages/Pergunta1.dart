...
import 'package:wizardry_gym_habits/Pages/Pergunta2.dart';
...
class _Pergunta1State extends State<Pergunta1> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Você notou alguma mudança recente no comportamento do seu parceiro(a)?',
            ...
            Column(
              ...
              children: [
                ...
                RadioListTile<int>(
                  title: Text('Leve alteração no comportamento'),
                  activeColor: Colors.redAccent,
                  value: 2,
                  groupValue: respostaSelecionada,
                  onChanged: (value) {
                ...
                RadioListTile<int>(
                  title: Text('Algumas mudanças notáveis'),
                  activeColor: Colors.redAccent,
                  value: 3,
                  groupValue: respostaSelecionada,
                  onChanged: (value) {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                if (respostaSelecionada != null) {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Pergunta2()),
                  );
                }
              },
  ...
  void Salvar() async {
    ...
    prefs.setString("Pergunta1", respostaSelecionada.toString());
  }
}
